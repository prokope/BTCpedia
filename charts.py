...
while True:
    ...
    btc_last_7_days_chart.update_xaxes(gridcolor='#252b57')
    ...
    btc_last_2_months_chart.update_yaxes(gridcolor='#252b57')
    ...
    btc_last_year_chart.update_yaxes(gridcolor='#252b57')
    btc_last_year_chart.show()
    btc_last_year_chart.write_html("btc_Last_year_chart.html")

    last_week_trades_chart = go.Figure([go.Bar(x = total_trades_last_week.index.to_list(), y = total_trades_last_week)],)
    last_week_trades_chart.update_xaxes(gridcolor='#252b57')
